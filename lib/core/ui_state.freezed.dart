...
class __$$_InitialCopyWithImpl<T, $Res>
    extends _$UIStateCopyWithImpl<T, $Res, _$_Initial<T>>
...
class __$$_DataCopyWithImpl<T, $Res>
    extends _$UIStateCopyWithImpl<T, $Res, _$_Data<T>>
...
abstract class _Data<T> implements UIState<T> {
...
abstract class _Error<T> implements UIState<T> {
  const factory _Error(final dynamic error) = _$_Error<T>;
